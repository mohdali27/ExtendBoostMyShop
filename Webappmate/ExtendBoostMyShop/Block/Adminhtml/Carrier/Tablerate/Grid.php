<?php
namespace Webappmate\ExtendBoostMyShop\Block\Adminhtml\Carrier\Tablerate;

/**
 * Supplier Shipping carrier table rate grid block
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Webappmate\ExtendBoostMyShop\Model\ResourceModel\Carrier\Tablerate\CollectionFactory
     */
     ...
     * @param \Webappmate\ExtendBoostMyShop\Model\ResourceModel\Carrier\Tablerate\CollectionFactory $collectionFactory
    ...
    public function __construct(
        ...
        \Webappmate\ExtendBoostMyShop\Model\ResourceModel\Carrier\Tablerate\CollectionFactory $collectionFactory,
    ...
    {
        parent::_construct();
        $this->setId('supplierTablerateGrid');
     ...
     *
     * @return \Webappmate\ExtendBoostMyShop\Block\Adminhtml\Carrier\Tablerate\Grid
     */
    protected function _prepareCollection()
    {

        /** @var $collection \Webappmate\ExtendBoostMyShop\Model\ResourceModel\Carrier\Tablerate\Collection */
        $collection = $this->_collectionFactory->create();
        $collection->setConditionFilter($this->getConditionName())->setWebsiteFilter($this->getWebsiteId())->setSupplierFilter($this->getSupplier());
