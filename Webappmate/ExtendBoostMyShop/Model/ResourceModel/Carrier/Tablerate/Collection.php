<?php
/**
 * Copyright © Webappmate
 */
namespace Webappmate\ExtendBoostMyShop\Model\ResourceModel\Carrier\Tablerate;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    protected function _construct()
    {
        $this->_init(
            ...
            \Webappmate\ExtendBoostMyShop\Model\ResourceModel\Tablerate::class
        );
    ...
    /**
     * Add supplier filter to collection
     *
     * @param string $conditionName
     * @return \Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate\Collection
     */
    public function setSupplierFilter($id)
    {
        return $this->addFieldToFilter('supplier_id', $id);
    }
}
